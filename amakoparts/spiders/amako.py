...
# https://parts.amaco.ua/ru/part/4ba5315f-f513-11e3-b5c5-00155d012119
    ...
    def parse_parts(self, response):
        ...
        product['metatitle'] = product['partid'] + ' ' + product['title']
        product['descriptions'] = product['partid'] + ' ' + product['title']
        product['sku'] = product['partid']
        yield product
